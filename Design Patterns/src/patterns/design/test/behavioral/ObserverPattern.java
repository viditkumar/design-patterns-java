 ...
 * A method to notify all the observers of any change and either it can send the update 
 * while notifying the observer or it can provide another method to get the update
 * 
...
interface Observer {
	// method to be used by Subject to notify of any change to the observer
	public void update();
